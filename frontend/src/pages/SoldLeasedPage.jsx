// // SoldLeasedPage.jsx — Public facing page
// // Reads from localStorage('sold_entries') saved by AdminDashboard
// // Design: #0f1a11 dark green | #c9a84c gold | #288849 emerald | #f4f1eb cream
...
//             <p style={{ color: '#c9a84c', fontSize: '0.8rem', fontFamily: 'sans-serif', letterSpacing: '4px', textTransform: 'uppercase', marginBottom: '1rem', marginTop: 0 }}>
//               Reflecting Our Commitment
//             </p>
//             <h1 style={{ fontSize: 'clamp(2.5rem,6vw,5rem)', color: 'white', lineHeight: 1.1, margin: '0 0 1.5rem 0' }}>
//               Success <span style={{ color: '#c9a84c' }}>Stories.</span>
//             </h1>
...
//       {/* ── Sticky Filters ── */}
//       <section style={{ background: '#0f1a11', padding: '1.5rem 0', position: 'sticky', top: 0, zIndex: 50, boxShadow: '0 4px 30px rgba(0,0,0,.3)' }}>
//         <div style={{ maxWidth: '1300px', margin: '0 auto', padding: '0 2rem', display: 'flex', gap: '1rem', flexWrap: 'wrap', alignItems: 'center' }}>

//           {/* Search */}
//           <div style={{ position: 'relative', flex: 1, minWidth: '200px' }}>
//             <Search size={16} style={{ position: 'absolute', left: '14px', top: '50%', transform: 'translateY(-50%)', color: '#c9a84c' }} />
//             <input
//               value={search}
...
//                 outline: 'none', fontFamily: 'sans-serif', fontSize: '0.9rem',
//                 boxSizing: 'border-box',
//               }}
//             />
//           </div>

//           {/* Status filter: All / Sold / Leased */}
...
//                   fontFamily: 'sans-serif', fontSize: '0.8rem', fontWeight: 600, transition: 'all .2s',
//                   background: statusFilter === s ? '#c9a84c' : 'rgba(255,255,255,.08)',
//                   color: statusFilter === s ? '#0f1a11' : 'rgba(255,255,255,.7)',
//                 }}
//               >
//                 {s}
//               </button>
...
//             onChange={e => handleFilter(setLocationFilter, e.target.value)}
//             style={{
//               padding: '10px 16px',
//               background: 'rgba(255,255,255,.07)',
//               border: '1px solid rgba(201,168,76,.3)',
//               borderRadius: '8px', color: 'white',
//               outline: 'none', fontFamily: 'sans-serif', fontSize: '0.85rem', cursor: 'pointer',
//             }}
//           >
//             {locations.map(l => <option key={l} value={l} style={{ background: '#0f1a11' }}>{l}</option>)}
//           </select>

//           <span style={{ color: 'rgba(255,255,255,.4)', fontSize: '0.8rem', fontFamily: 'sans-serif', marginLeft: 'auto', whiteSpace: 'nowrap' }}>
...
//               style={{
//                 display: 'grid',
//                 gridTemplateColumns: 'repeat(3, 1fr)',   // ← FIXED: 3 cards per row
//                 gap: '1.5rem',
//               }}
//             >
...
//                         fontSize: '0.68rem', fontFamily: 'sans-serif', fontWeight: 700, letterSpacing: '.5px',
//                       }}>
//                         <CheckCircle2 size={11} /> {(item.status || 'SOLD').toUpperCase()}
//                       </span>
//                       <span style={{
//                         display: 'inline-flex', alignItems: 'center', gap: '4px',
//                         background: '#f4f1eb', color: '#6b7280',
//                         padding: '4px 8px', borderRadius: '6px',
//                         fontSize: '0.68rem', fontFamily: 'sans-serif', fontWeight: 600,
//                       }}>
...
//                       <div>
//                         <div style={{ fontSize: '1.2rem', fontWeight: 700, color: '#0f1a11', lineHeight: 1.2 }}>
//                           {item.title}
//                         </div>
//                         {item.location && (
//                           <div style={{ fontSize: '0.82rem', color: '#6b7280', fontFamily: 'sans-serif', marginTop: '3px' }}>
//                             {item.location}
//                           </div>
//                         )}
//                       </div>
...
//                         fontFamily: 'sans-serif', fontWeight: 700, fontSize: '0.9rem', transition: 'all .2s',
...
//           </p>
//           <button style={{
//             background: '#c9a84c', color: '#0f1a11', border: 'none',
//             padding: '1rem 3rem', borderRadius: '4px',
//             fontFamily: 'sans-serif', fontWeight: 700, fontSize: '0.9rem', letterSpacing: '1px', cursor: 'pointer',
//           }}>
//             BOOK A CONSULTATION
//           </button>
//         </motion.div>
