...
//           <div className="admin-table-container">
//             <h3 className="serif" style={{ fontSize: '1.5rem', marginBottom: '2rem' }}>Property Approvals</h3>
//             <div style={{ marginBottom: '1rem', padding: '0.75rem 1rem', background: 'rgba(201,168,76,0.1)', borderRadius: '8px', borderLeft: '3px solid var(--accent-gold)' }}>
//               <p style={{ fontSize: '0.85rem', margin: 0 }}>📋 Pending approvals from property submissions</p>
//             </div>
//             <table className="admin-table">
//               <thead>
//                 <tr>
...
//                           <button 
//                             onClick={() => handleApprove(prop.id)} 
//                             style={{ background: '#288849', color: 'white', border: 'none', padding: '6px 14px', borderRadius: '4px', cursor: 'pointer', fontSize: '0.8rem', fontWeight: 'bold' }}
//                           >
//                             Approve
//                           </button>
//                           <button 
//                             onClick={() => handleReject(prop.id)} 
//                             style={{ background: '#d32f2f', color: 'white', border: 'none', padding: '6px 14px', borderRadius: '4px', cursor: 'pointer', fontSize: '0.8rem', fontWeight: 'bold' }}
//                           >
//                             Reject
//                           </button>
//                         </div>
...
//               <button 
//                 className="book-btn" 
//                 style={{ width: 'fit-content', padding: '1rem 3rem', cursor: 'pointer' }}
...
//               >
//                 {item.icon} 
//                 <span style={{ marginLeft: '12px', flex: 1 }}>{item.id}</span>
//                 {isDisabled && <span style={{ fontSize: '0.65rem', color: '#888' }}>(Soon)</span>}
//               </div>
//             );
//           })}
//         </nav>
//         <div style={{ marginTop: 'auto', borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '1rem', cursor: 'pointer' }} 
